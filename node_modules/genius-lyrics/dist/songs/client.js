    ...
    search(query, options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((0, types_1.isString)(this.client.key)) {
                ...
                const res = yield got_1.default.get(`${((_b = this.client.config.origin) === null || _b === void 0 ? void 0 : _b.url) || constants_1.Constants.unofficialApiURL}/search/multi?per_page=5&q=${encodedQuery}`, Object.assign(Object.assign({}, this.client.config.requestOptions), { headers: Object.assign({ "User-Agent": constants_1.Constants.defaultUserAgent }, (_c = this.client.config.requestOptions) === null || _c === void 0 ? void 0 : _c.headers) }));
                ...
                if (!((_e = __hits === null || __hits === void 0 ? void 0 : __hits.hits) === null || _e === void 0 ? void 0 : _e.length)) {
                    throw new errors_1.NoResultError();
                }
                result = __hits.hits;
            }
